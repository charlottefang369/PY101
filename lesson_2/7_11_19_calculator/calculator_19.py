...
# Input: 
#   Ask the user for two numbers. Allowing Floating-Point Numbers.
...
#   Create functions and loops to validate inputs (number1, number2, operation type, answer to if want another calculation)
...
while True:
    ...
    while True:
        ...
        prompt(messages('invalid_answer'))1
